...
# cv2.createTrackbar('t', 'settings', 0, 255, nothing)
# cv2.createTrackbar('h', 'settings', 0, 255, nothing)
# crange = [0]
...
#     t = cv2.getTrackbarPos('t', 'settings')
#     h = cv2.getTrackbarPos('h', 'settings')
    
#     ret, threshold_image = cv2.threshold(gray, t, h, 0)
