...
# =============================================================================
os.chdir("D:/abyss_of_work/main/Aleksandr_G.K/summer_practice/projects/heart_filtres/frames")
...
path_a = r'D:\abyss_of_work\main\Aleksandr_G.K\summer_practice\projects\heart_filtres\frames\frame'+str(i)+'.jpg'
path_b = r'D:\abyss_of_work\main\Aleksandr_G.K\summer_practice\projects\heart_filtres\frames\frame'+str(i+1)+'.jpg'
...
plt.savefig(r'D:/abyss_of_work/main/Aleksandr_G.K/2021/Image-processing/vortex analysis/vector_field/'+str(a), dpi = 300)
plt.show()
