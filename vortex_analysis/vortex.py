...
'''Расчёт лямбд'''
# =========================================================================
os.chdir("D:/abyss_of_work/main/Aleksandr_G.K/Projects/Image-processing/vortex_analysis/drop/index")
...
for j in range(num_of_images):
    ...
    path = r'D:/abyss_of_work/main/Aleksandr_G.K/Projects/Image-processing/vortex_analysis/drop/L/'
    writer = pd.ExcelWriter(path+"Lci_"+str(j)+".xlsx", engine='xlsxwriter')
...
data = pd.read_excel('D:/abyss_of_work/main/Aleksandr_G.K/Projects/Image-processing/vortex_analysis/output.xlsx') # из таблицы берем координаты точек
...
for k in range(num_of_files-1):
    ...
    # =======
    Lci_data_path = r'D:/abyss_of_work/main/Aleksandr_G.K/Projects/Image-processing/vortex_analysis/drop/L/'
    ...
    # =======
        ...
        Real1.append(float(Lci_data.loc[i, 'Lci1']))
    ...
    plt.savefig(r'D:/abyss_of_work/main/Aleksandr_G.K/Projects/Image-processing/vortex_analysis/drop/heatmap/Re1/'+str(a), dpi = 300)
    # =======
    fig, ax = plt.subplots(figsize=(12,10),dpi=300)
    ...
    plt.savefig(r'D:/abyss_of_work/main/Aleksandr_G.K/Projects/Image-processing/vortex_analysis/drop/heatmap/Re2/'+str(b), dpi = 300)
    plt.show()
    # =======