...
'''Расчёт лямбд'''
# =========================================================================
os.chdir("D:/abyss_of_work/main/Aleksandr_G.K/Projects/Image-processing/vortex_analysis/index")
...
for j in range(num_of_images):
    ...
    path = r'D:/abyss_of_work/main/Aleksandr_G.K/Projects/Image-processing/vortex_analysis/test/'
